...
//#include "InOutAdvClnt.hpp"
//#include "InOutClnt.hpp"
//#include "InOutServer_TLB.hpp"
...
typedef enum _StringType  {stStandart = 0, stRep = 523,st_Blue = 524, stBlackBold = 525, stError = 526} StringType;
...
void __fastcall ErrorMessageBox( String Message, AnsiString Title = "");
void __fastcall WarningMessageBox( String Message, AnsiString Title = "");
void __fastcall InformationMessageBox( String Message, AnsiString Title = "");
int __fastcall QuestionMessageBox( String Message, AnsiString Title = "", UINT nStyle = MB_OKCANCEL + MB_ICONQUESTION);
